      ...
      <div className="returns-page">
        ...
        <div className="container">
          <div className="returns-body">
            ...
            <p>If a piece arrives damaged as a direct result of transit, not a condition issue that was present and documented before shipping. If the damage was caused by the shipping process, contact us within 48 hours of receipt with photographs. We will address it. This is the only exception.</p>
